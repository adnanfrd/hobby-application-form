...
export function Navigation({ showBackLink = false }: NavProps) {
  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-[6%] py-[18px] bg-midnight/90 backdrop-blur-[12px] border-b border-border-white transition-all duration-300 ${
